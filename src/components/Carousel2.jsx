...
const Carousel = () => {
  return (
    <div className="flex items-center justify-center p-5 mt-[120px] xs:h-[70vh] md:h-[60vh] bg-[var(--body-color)]">
      <Swiper
        modules={[Navigation]}
        loop={true}
        ...
        autoplay={false}
        className="relative w-[1400px] mx-auto"
        breakpoints={{
          // For small devices, show 1 slide per view like a card
          340: {
            slidesPerView: 1.5,
            spaceBetween: 10,
          },
