...
import { HeroParallax } from "../pages/acertinityComponents/HeroParalax";
    ...
    <div className="bg-black w-full mt-10">
      <div className="h-[300px] flex justify-center items-center bg-black shadow-2xl px-4 sm:px-6 md:px-8 lg:px-12">
        <div className="flex flex-col items-center p-4 sm:p-6 md:p-8 lg:p-12 rounded mt-24">
          ...
          <h1
            style={gradientStyle}
            className="text-center text-transparent bg-gradient-to-b bg-clip-text from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800 dark:via-black dark:to-black font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-[50px]"
          >
