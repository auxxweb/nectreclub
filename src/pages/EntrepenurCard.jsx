...
import { Sparkles } from "../pages/acertinityComponents/Tools";
...
export default function TestimonialSection() {
  ...
  return (
    <div className="w-full min-h-[200px]  z-auto flex items-center justify-center text-[#D8D9D9] p-8 rounded-3xl shadow-lg relative overflow-hidden">
